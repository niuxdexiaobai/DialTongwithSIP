...
public class T9Adapter extends BaseAdapter implements Filterable{
	...
	public View getView(final int position, View convertView, ViewGroup parent) {   
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.home_t9_list_item, parent, false);//����listview��ʾ����Ĳ����ļ�
			holder = new ViewHolder();
			holder.name = (TextView) convertView.findViewById(R.id.name);  //ʵ������ʾ���ֵĵط�
//			holder.pinyin = (TextView) convertView.findViewById(R.id.pinyin);  //ʵ������ʾ����ƴ���ĵط�
			holder.number = (TextView) convertView.findViewById(R.id.number);  //ʵ������ʾ����ĵط�
			holder.filterLinearLayout = (RelativeLayout) convertView.findViewById(R.id.filterLinearLayout);
		}else{
		...
		if (null == filterNum || "".equals(filterNum)) {//ʵ�ֺ���ɸѡ����
...
//				holder.pinyin.setText(Html.fromHtml(formattedNumber));
		...
		holder.filterLinearLayout.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Uri uri = Uri.parse("tel:" + list.get(position).getPhoneNum());
	...
	public final class ViewHolder {   
		...
		public RelativeLayout filterLinearLayout;
	}
