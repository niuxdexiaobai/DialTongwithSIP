...
public class QuickAlphabeticBar extends ImageButton{
	...
	public void init(ContactsActivity contactsFragment) {
		mDialogText = (TextView) contactsFragment.findViewById(R.id.fast_position);
	...
	public void init(ContactsFavorActivity contactsFavorActivity) {
		// TODO Auto-generated method stub
		mDialogText = (TextView) contactsFavorActivity.findViewById(R.id.fast_position);
		mDialogText.setVisibility(View.INVISIBLE);
		mHandler = new Handler();
	}
