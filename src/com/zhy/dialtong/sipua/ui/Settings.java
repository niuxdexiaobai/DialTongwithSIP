...
package com.zhy.dialtong.sipua.ui;
...
import com.zhy.dialtong.sipua.codecs.Codecs;
import com.zhy.dialtong.sipua.media.RtpStreamReceiver;
...
public class Settings extends PreferenceActivity implements OnSharedPreferenceChangeListener, OnClickListener {
	...
	private final static String profilePath = "/sdcard/Dialtong/";
	// Path where is stored the shared preference file - !!!should be replaced by some system variable!!!
	private final String sharedPrefsPath = "/data/data/com.zhy.dialtong/shared_prefs/";
	// Shared preference file name - !!!should be replaced by some system variable!!!
	private final String sharedPrefsFile = "com.zhy.dialtong_preferences";
